...
game_table 				= 'CREATE TABLE "game" ("id" integer NOT NULL PRIMARY KEY, "season_code" varchar(4), "year_code" varchar(16), "game_code" varchar(8), "home_team_id" integer NOT NULL REFERENCES "hockey_team" ("id"), "home_score" integer NOT NULL, "away_team_id" integer NOT NULL REFERENCES "hockey_team" ("id"), "away_score" integer NOT NULL, "start_time" varchar(16) NOT NULL, "end_time" varchar(16) NOT NULL, attendance integer NOT NULL);'
...
face_off_table			= 'CREATE TABLE "face_off" ("id" integer NOT NULL PRIMARY KEY, "game_id" integer NOT NULL REFERENCES "game" ("id"), "play_id" integer NOT NULL REFERENCES "play" ("id"), "winner" integer NOT NULL REFERENCES "skater" ("id"), "loser" integer NOT NULL REFERENCES "skater" ("id"), "zone_id" integer NOT NULL REFERENCES "zone_types" ("id") );'
...
block_table				= 'CREATE TABLE "block" ("id" integer NOT NULL PRIMARY KEY, "game_id" integer NOT NULL REFERENCES "game" ("id"), "play_id" integer NOT NULL REFERENCES "play" ("id"), "shooter" integer NOT NULL REFERENCES skater ("id"), "blocker" integer NOT NULL REFERENCES skater ("id"), "shot_type_id" integer NOT NULL REFERENCES shot_type ("id"), "zone_type_id" integer NOT NULL REFERENCES zone_type ("id") );'
...
shot_table				= 'CREATE TABLE "shot" ("id" integer NOT NULL PRIMARY KEY, "game_id" integer NOT NULL REFERENCES "game" ("id"), "play_id" integer NOT NULL REFERENCES "play" ("id"), "shooter" integer NOT NULL REFERENCES skater ("id"), "shot_type_id" integer NOT NULL REFERENCES shot_type ("id"), "zone_type_id" integer NOT NULL REFERENCES zone_type ("id"), "distance" integer NOT NULL );'
...
hit_table				= 'CREATE TABLE "hit" ("id" integer NOT NULL PRIMARY KEY, "game_id" integer NOT NULL REFERENCES "game" ("id"), "play_id" integer NOT NULL REFERENCES "play" ("id"), "hitter" integer NOT NULL REFERENCES skater ("id"), "hittee" integer NOT NULL REFERENCES skater ("id"), "zone_type_id" integer NOT NULL REFERENCES "zone_type" ("id") );'
...
stop_table				= 'CREATE TABLE "stop" ("id" integer NOT NULL PRIMARY KEY, "game_id" integer NOT NULL REFERENCES "game" ("id"), "play_id" integer NOT NULL REFERENCES "play" ("id"), "stop_type_id" integer NOT NULL REFERENCES stop_type ("id") );'
...
miss_table				= 'CREATE TABLE "miss" ("id" integer NOT NULL PRIMARY KEY, "game_id" integer NOT NULL REFERENCES "game" ("id"), "play_id" integer NOT NULL REFERENCES "play" ("id"), "shooter" integer NOT NULL REFERENCES skater ("id"), "miss_type_id" integer NOT NULL REFERENCES miss_type ("id"), "shot_type_id" integer NOT NULL REFERENCES shot_type ("id"), "zone_type_id" integer NOT NULL REFERENCES zone_type ("id"), "distance" integer NOT NULL );'
